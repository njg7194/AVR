...
_0x3:
	...
	.DB  0x80,0x90
_0x0:
	.DB  0x44,0x69,0x73,0x74,0x3A,0x25,0x64,0x20
	.DB  0x6D,0x6D,0x0
_0x2020060:
	.DB  0x1
_0x2020000:
...
; 0000 00BD     ovf_count++;    // 매 16μs 마다 인터럽트 발생
	LDI  R26,LOW(_ovf_count)
	LDI  R27,HIGH(_ovf_count)
	RCALL __GETD1P_INC
	__SUBD1N -1
	RCALL __PUTDP1_DEC
; 0000 00BE }
...
; 0000 0121 {
_MeasureDistanceByUSS:
; .FSTART _MeasureDistanceByUSS
...
;	distance -> Y+0
	LDI  R30,LOW(0)
	STS  _ovf_count,R30
	STS  _ovf_count+1,R30
	STS  _ovf_count+2,R30
	STS  _ovf_count+3,R30
...
; 0000 012B     rise_time = ovf_count;
	RCALL SUBOPT_0x4
	STS  _rise_time,R30
	STS  _rise_time+1,R31
	STS  _rise_time+2,R22
	STS  _rise_time+3,R23
...
; 0000 012D     fall_time = ovf_count;
	RCALL SUBOPT_0x4
	STS  _fall_time,R30
	STS  _fall_time+1,R31
	STS  _fall_time+2,R22
	STS  _fall_time+3,R23
; 0000 012E 
...
; 0000 0130     distance = SOUND_SPEED_mm*OVF_PERIOD_s*(fall_time-rise_time)/2.f;
	LDS  R26,_rise_time
	LDS  R27,_rise_time+1
	LDS  R24,_rise_time+2
	LDS  R25,_rise_time+3
	LDS  R30,_fall_time
	LDS  R31,_fall_time+1
	LDS  R22,_fall_time+2
	LDS  R23,_fall_time+3
	RCALL __SUBD12
	RCALL __CDF1
	__GETD2N 0x40AE147B
	RCALL __MULF12
...
; 0000 0132         distance = old_distance;     // 거리 값이 50mm이하이면 이전데이터 리턴
	LDS  R30,_old_distance_S0000004000
	LDS  R31,_old_distance_S0000004000+1
	LDS  R22,_old_distance_S0000004000+2
	LDS  R23,_old_distance_S0000004000+3
	RCALL SUBOPT_0x5
; 0000 0133     else
	RJMP _0x47
_0x46:
; 0000 0134         old_distance = distance;     // 지금의 데이터를 예전 데이터변수로 전달
	RCALL SUBOPT_0x6
	STS  _old_distance_S0000004000,R30
	STS  _old_distance_S0000004000+1,R31
	STS  _old_distance_S0000004000+2,R22
	STS  _old_distance_S0000004000+3,R23
...
SUBOPT_0x3:
	LDS  R26,_ovf_count
	LDS  R27,_ovf_count+1
	LDS  R24,_ovf_count+2
	LDS  R25,_ovf_count+3
	__CPD2N 0x899
	RET
...
SUBOPT_0x4:
	LDS  R30,_ovf_count
	LDS  R31,_ovf_count+1
	LDS  R22,_ovf_count+2
	LDS  R23,_ovf_count+3
	RET
